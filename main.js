...
function question1() {
	$("querySelectorAll").css.style.backgroundColor("blue");
}
 ...
 */
function question2() {
$("querySelectorAll").css.style.h2("Reema");
}
 ...
 */
	...
	// function question3(){
	// 	$("querySelectorAll").html("falseFact");
	// }
 ...
 */
function question4 (){
 $("blockquote").html("background-color", "pink")
}
...
function question9 (){
	$("blockquote").css.style.color("blue"), css.style.fontFamily("Georgia") 
	}
